...
class PassphraseForm extends HookWidget {
  const PassphraseForm({Key? key, this.onSubmit}) : super(key: key);

  final Function(String passphrase)? onSubmit;
  List<String>? errors() => [];
            ...
            actionButtons: <Widget>[
              ElevatedButton(
                ...
                onPressed: onSubmit != null
                    ? () => onSubmit!(passphraseController.value.text)
                    : null,
              )
            ],
            children: <Widget>[
